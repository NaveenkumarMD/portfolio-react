...
import wesbitelogo from '../Assets/website.png'
                        ...
                        <div className='pv-container'>
                                        ...
                                        <div ref={heartref} className="pv-heart-container">
                                            {
                                                liked ?
                                                    ...
                                                    :
                                                    <>
                                                        <RiHeart3Line color='white' size={20} onClick={
                                                            () => setliked(true)
                                                        } />
                                                        <span className='pv-heart-count'>{345}</span>
                                                    </>
                            ...
                            <div className="pv-content">
                                <div className='pv-description'>
                                    <div className='pv-description-title'>
                                        Description
                                    </div>
                                    <div className='pv-description-content'>
                                        <div>
                                            This is a web scraper that can scrape data from a webpage and store it in a database.
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div>
                                        <div className='pv-comm1'>
                                            ...
                                            <div className='pv-comment-content'>
                                                <div className='pv-comment-name'>
                                                    Naveen Kuamr
                                                </div>
                                                <div className='pv-comment-date'>
                                                    1 day ago
                                                </div>
                            ...
                            <div className='pv-add-comment-container' ref={popupcommentcommentref}>
                                <div className='pv-comment-input' >
                                    <input placeholder='Enter your comment...' value={comment}
                            ...
                            <div className='pv-add-comment-container1' ref={popupcommentnameref}>
                                <div className='pv-comment-input'>
                                    <input placeholder='How can I call you...' value={name}
