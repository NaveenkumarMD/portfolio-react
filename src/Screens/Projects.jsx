          ...
          projects
				...
				<div className="blogs-content">
					<div className="blogs-menu" data-aos="fade-right">
						<div ref={allref} onClick={() => setSelectedtag("all")}>
              all
						</div>
						<div ref={websiteref} onClick={() => setSelectedtag("website")}>
              websites
						</div>
						<div ref={appsref} onClick={() => setSelectedtag("app")}>
              apps
						</div>
						<div ref={modulesref} onClick={() => setSelectedtag("module")}>
              modules
						</div>
					</div>
					<div className="blogs-flex">
						{Projectdata.contents.map((item, index) => {
							if (selectedtag == "all" || item.tag == selectedtag) {
								return <Projectcontainer key={index} data={item} />;
							}
						})}
					</div>
				</div>
